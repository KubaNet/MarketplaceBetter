...
IF NOT EXISTS (SELECT NULL FROM [dbo].[PhotoType] WHERE [SystemName] = 9)
    INSERT INTO [dbo].[PhotoType] ([Name], [SystemName], [AmazonUploadCode])
    VALUES ('Other 7', 9, 'PT07')
ELSE UPDATE [dbo].[PhotoType] SET [Name] = 'Other 7', [AmazonUploadCode] = 'PT07' WHERE [SystemName] = 9
GO

IF NOT EXISTS (SELECT NULL FROM [dbo].[PhotoType] WHERE [SystemName] = 10)
    INSERT INTO [dbo].[PhotoType] ([Name], [SystemName], [AmazonUploadCode])
    VALUES ('Other 8', 10, 'PT08')
ELSE UPDATE [dbo].[PhotoType] SET [Name] = 'Other 8', [AmazonUploadCode] = 'PT08'  WHERE [SystemName] = 10
GO