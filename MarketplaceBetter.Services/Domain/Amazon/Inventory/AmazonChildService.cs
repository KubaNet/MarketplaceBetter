    ...
    public class AmazonChildService : IAmazonChildService
    {
        ...
        public void AddForParent(long parentId)
        {
            ...
            foreach (var Variant in Variants)
            {
                ...
                AmazonChild child = new AmazonChild { ParentId = parentId, VariantId = Variant.Id, 
        ...
        public void AddForVariant(long VariantId)
        {
            ...
            AmazonParent parent = _parentRepository.SingleOrDefault(p => p.ProductId == Variant.ProductId);
            ...
            if (parent != null)
            {
                ...
                child = new AmazonChild { ParentId = parent.Id, VariantId = VariantId,
        ...
        private IQueryable<AmazonChild> ApplySorting(IQueryable<AmazonChild> childs, ListRequest request)
        {
        ...
        private IQueryable<AmazonChild> ApplyPaging(IQueryable<AmazonChild> childs, ListRequest request)
        {
