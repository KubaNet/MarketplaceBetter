...
namespace MarketplaceBetter.Domain.Constants
{
    public static class Standard
    {
        ...
        public const int InitialRowsPerPage = 200;

        public const int SmallestRowsPerPage = 50;

        public const int MediumRowsPerPage = 200;

        public const int LargestRowsPerPage = 500;
        ...
        public const string SearchQueryParamater = "SearchString";
